...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	http.authorizeRequests()
		 ...
		 * "/api/clientes/upload").hasAnyRole("USER", "ADMIN") // cargar archivo
		 * .antMatchers(HttpMethod.POST, "/api/clientes").hasRole("ADMIN")// post solo
		 * admin .antMatchers("/api/clientes/**").hasRole("ADMIN") // aplica para put,
		 * delete y cualquier otro
		 */
